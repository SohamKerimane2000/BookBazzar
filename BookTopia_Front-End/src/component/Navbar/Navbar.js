...
//                     <Link to="/" className="navbar-brand text-white"><i className="fa-solid fa-book" /> BookBazzar</Link>
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">
                        <i className="fa-solid fa-book text-warning me-2" /> 
                        <span className="brand-name">BookBazzar</span>
                    </Link>
                    <button 
                            ...
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li className="nav-item">
                                    <Link to="/cart" className="nav-link">
                                        ...
                                        {cartNo && <span className="badge bg-warning text-dark ms-2">{cartNo}</span>}
                                    </Link>
                                </li>
                                <li className="nav-item">
